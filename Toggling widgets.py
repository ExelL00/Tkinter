...
menu_button3.grid(row=1,column=0,columnspan=3,sticky='nesw')

menu_slider1.grid(row=2,column=0,rowspan=2,sticky='nesw',pady=20)
menu_slider2.grid(row=2,column=2,rowspan=2,sticky='nesw',pady=20)
...
main_button=ttk.Button(entry_frame1,text="Button 1")
